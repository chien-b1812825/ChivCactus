          ...
          <div class="col-md-12">
            ...
            <!-- start header top left -->
              <div class="aa-header-top-left">
                ...
                <!-- start cellphone -->
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>09999-799-777</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                <!-- Text based logo -->
                <a href="{!! URL('/') !!}">
                  <span class="fa fa-cactus"></span>
                  <p>Xương rồng <strong>Chiv</strong> <span>Good cactus - High quality</span></p>
                </a>
                <!-- img based logo -->
